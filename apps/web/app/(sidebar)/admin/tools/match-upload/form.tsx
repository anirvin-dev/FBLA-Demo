...
export function MatchUploadForm() {
    const [state, formAction, isPending] = useActionState(submitForm, { success: false, error: null });
        ...
        <form action={formAction} className="flex flex-col gap-y-4">
            <div className="flex gap-x-2">
                ...
                <div>
                    ...
                    <Input placeholder="2025 Thor West Offseason" name="eventName" />
                </div>
            </div>
            <div className="flex gap-x-2">
                <div>
            ...
            <div>
                ...
                <Input className="w-fit" type="file" accept=".csv" name="csvUpload" />
            </div>
            <div className="flex">
                <Button disabled={isPending} className="btn btn-primary">{isPending ? 'Uploading...' : 'Upload'}</Button>
            </div>
        </form>
    );
}
