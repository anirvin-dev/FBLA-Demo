...
export async function submitForm(_: SubmitFormResponse, formData: FormData): Promise<SubmitFormResponse> {
    ...
    if (!eventCode || !eventName || isNaN(startDate.getTime()) || isNaN(endDate.getTime()) || !csvFile) {
